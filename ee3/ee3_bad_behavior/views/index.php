<?php
	//echo form_open('C=addons_extensions'.AMP.'M=save_extension_settings'.AMP.'file=ee3_bad_behavior');
	echo form_open(ee('CP/URL')->make('addons/settings/ee3_bad_behavior/save'));
...
<script type="text/javascript">
	...
	var css = document.createElement("style");
		css.type = "text/css";
		css.innerHTML = "td { white-space: normal; }";
...
/* Location: ./system/user/addons/ee3_bad_behavior/views/index.php */