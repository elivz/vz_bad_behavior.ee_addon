...
VZ Bad Behavior is compatible with ExpressionEngine 3.x, 4.x, & 5.x. The [EE2 version is here](https://github.com/elivz/vz_bad_behavior.ee_addon/tree/ee2).
...
Thanks to [ilab crossmedia](http://www.ilab.at) for updating this add-on for compatiblity with ExpressionEngine 3+.
